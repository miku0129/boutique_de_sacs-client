export const client_notification_gn = {
  ...
  text1:
    "Contactez-nous à travers la rubrique 'contact'. Indiquez l'article que vous souhaitez acheter.",
  text2:
  ...
  text3: "Vous réglez un acompte d'une valeur de 50% via un lien Sumup.",
  text4:
